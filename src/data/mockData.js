...
export const locationsBar = [
  { id: 1, label: "Beach", icon: <MdBeachAccess size={24} /> },
  { id: 2, label: "Amazing Pools", icon: <FaSwimmingPool size={24} /> },
  { id: 3, label: "Island", icon: <GiIsland size={24} /> },
  { id: 4, label: "Arctic", icon: <BsSnow size={24} /> },
  { id: 5, label: "Castles", icon: <GiCastle size={24} /> },
  { id: 6, label: "OMG!", icon: <GiSpaceNeedle size={24} /> },
  { id: 7, label: "Amazing Views", icon: <MdReviews size={24} /> },
  { id: 8, label: "Design", icon: <MdHouseboat size={24} /> },
  { id: 9, label: "Surfing", icon: <GiWaveSurfer size={24} /> },
  { id: 10, label: "Bed & Breakfast ", icon: <AiOutlineCoffee size={24} /> },
  { id: 11, label: "Caves", icon: <GiCaveEntrance size={24} /> },
  { id: 12, label: "National Parks", icon: <GiKidSlide size={24} /> },
  { id: 13, label: "Shared Homes", icon: <MdHouseSiding size={24} /> },
  { id: 14, label: "Earth Homes", icon: <RiEarthquakeFill size={24} /> },
  { id: 15, label: "Tropical", icon: <FaUmbrellaBeach size={24} /> },
  { id: 16, label: "CountrySide", icon: <GiMountainCave size={24} /> },
  { id: 17, label: "Lake", icon: <MdOutlineWater size={24} /> },
  { id: 18, label: "Tiny Homes", icon: <BiHomeAlt size={24} /> },
  { id: 19, label: "Campers", icon: <FaCampground size={24} /> },
  { id: 20, label: "Cabins", icon: <MdCabin size={24} /> },
];
...
export const locations = [
  ...
  },
  {
    ...
    location: "3 Bedroom Flat in Yaba",
    host: "Vicky",
    days: "Nov 19-22",
    price: "$129 night",
    isNew: true,
  ...
  },
  {
    ...
    location: "Studio Apartment Yaba",
    host: "Jerry",
    days: "Sep 13-18",
    price: "$208 night",
    isNew: false,
  ...
  },
  {
    ...
    location: "Semi Detached Duplex Ketu",
    host: "Vincent",
    days: "June 7-12",
    price: "$467 night",
    isNew: true,
  ...
  },
  {
    ...
    location: "5 Bedroom Duplex Abule Egba",
    host: "Charles",
    days: "Jun 11-16",
    price: "$150 night",
    isNew: false,
  ...
  },
  {
    ...
    location: "2 Bedroom Flat Ikotun",
    host: "Vicky",
    days: "Jun 12-18",
    price: "$629 night",
    isNew: false,
  ...
  },
  {
    ...
    location: "Terrace Apartment Lekki",
    host: "Victor",
    days: "Nov 2-7",
    price: "$256 night",
    isNew: false,
  ...
  },
  {
    ...
    location: "Bungalow with pool Ikoyi",
    host: "Caroline",
    days: "Nov 4-10",
    price: "$777 night",
    isNew: true,
