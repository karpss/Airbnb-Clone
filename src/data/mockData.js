...
export const locationsBar = [
  { id: 0, label: "Beach", icon: <MdBeachAccess size={24} /> },
  { id: 1, label: "Amazing Pools", icon: <FaSwimmingPool size={24} /> },
  { id: 2, label: "Island", icon: <GiIsland size={24} /> },
  { id: 3, label: "Arctic", icon: <BsSnow size={24} /> },
  { id: 4, label: "Castles", icon: <GiCastle size={24} /> },
  { id: 5, label: "OMG!", icon: <GiSpaceNeedle size={24} /> },
  { id: 6, label: "Amazing Views", icon: <MdReviews size={24} /> },
  { id: 7, label: "Design", icon: <MdHouseboat size={24} /> },
  { id: 8, label: "Surfing", icon: <GiWaveSurfer size={24} /> },
  { id: 9, label: "Bed & Breakfast ", icon: <AiOutlineCoffee size={24} /> },
  { id: 10, label: "Caves", icon: <GiCaveEntrance size={24} /> },
  { id: 11, label: "National Parks", icon: <GiKidSlide size={24} /> },
  { id: 12, label: "Shared Homes", icon: <MdHouseSiding size={24} /> },
  { id: 13, label: "Earth Homes", icon: <RiEarthquakeFill size={24} /> },
  { id: 14, label: "Tropical", icon: <FaUmbrellaBeach size={24} /> },
  { id: 15, label: "CountrySide", icon: <GiMountainCave size={24} /> },
  { id: 16, label: "Lake", icon: <MdOutlineWater size={24} /> },
  { id: 17, label: "Tiny Homes", icon: <BiHomeAlt size={24} /> },
  { id: 18, label: "Campers", icon: <FaCampground size={24} /> },
  { id: 19, label: "Cabins", icon: <MdCabin size={24} /> },
];
